...
export const navigation = {
  ...
  qaType: [
    ...
    { href: "/templates/qa-type/before-apply", label: "応募前の疑問" },
    { href: "/templates/qa-type/selection", label: "選考について" },
    { href: "/templates/qa-type/after-joining", label: "入社後について" },
    { href: "/templates/qa-type/workstyle", label: "働き方Q&A" },
    { href: "/templates/qa-type/jobs", label: "募集要項" },
    { href: "/templates/qa-type/contact", label: "まだ不安がある方へ" },
  ],
} as const;
...
export const templates = [
  ...
  },
  {
    ...
    name: "Q&A解決型",
    subtitle: "不安解消採用サイト",
    description: "求職者の疑問・不安・懸念を先回りして徹底的に解消し、応募のハードルを限りなく下げる対話型サイトです。",
    features: [
      "Q&A形式で不安解消",
      "透明性の高い情報開示",
      "選考プロセスの可視化",
    ...
    suitableFor: [
      "未経験者採用を積極的に行う企業",
      "業界・職種にネガティブイメージがある企業",
      "丁寧な説明で信頼を得たい企業",
      "透明性を重視する企業文化",
    ],
    color: "#4CAF50",
    href: "/templates/qa-type",
    image: "/images/templates/qa-type/thumbnail.jpg",
    status: "available",
  },
] as const;
