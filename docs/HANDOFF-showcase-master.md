...
|---|-------------|------|--------|--------|------|---------|------|
| 1 | trust-visual | 90% | 6/6 ✅ | ✅ | ✅ | ✅ | 🟢 実装完了（要確認） |
| 2 | fullorder | 90% | 6/6 ✅ | ✅ | ❌ | ✅ | 🟢 実装完了（要確認） |
| 3 | recruit-magazine | 85% | 8/7 ✅ | ✅ | ❌ | - | 🟢 実装完了（要確認） |
| 4 | leadgen-visual | 85% | 6/6 ✅ | ✅ | ❌ | ✅ | 🟢 実装完了（要確認） |
| 5 | leadgen-minimal | 90% | 7/6 ✅ | ✅ | ❌ | ✅ | 🟢 実装完了（要確認） |
| 6 | authority-minimal | 90% | 6/6 ✅ | ✅ | ❌ | ✅ | 🟢 実装完了（要確認） |
| 7 | standard | 90% | 6/6 ✅ | ✅ | ❌ | ✅ | 🟢 実装完了（要確認） |
